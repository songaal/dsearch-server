...
//import java.util.*;
//
//public class JdbcServiceImplBak {
//    private static Logger logger = LoggerFactory.getLogger(JdbcServiceImplBak.class);
//    private String jdbcIndex;
//    private final String JDBC_JSON = "jdbc.json";
//    private final ElasticsearchFactory elasticsearchFactory;
//    private IndicesService indicesService;
//
//    public JdbcServiceImplBak(@Value("${dsearch.jdbc.setting}") String jdbcIndex,
