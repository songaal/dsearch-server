...
public class IndexerClient {
    ...
    public IndexerClient(IndexJobManager indexerJobManager){
    ...
    public void stopJobForExternal(String scheme, String host, int port, String jobId) throws URISyntaxException {
    ...
    public void stopJobForInternal(String jobId){
